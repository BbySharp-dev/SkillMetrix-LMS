        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoTimestampSeconds = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFinalQuiz = table.Column<bool>(type: "boolean", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizId = table.Column<Guid>(type: "uuid", nullable: false),
                    Content = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    Point = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    OrderIndex = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_QuizOptions_Id_QuestionId", x => new { x.Id, x.QuestionId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuizAttemptAnswers_QuizOptions_SelectedOptionId_QuestionId",
                        columns: x => new { x.SelectedOptionId, x.QuestionId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttemptAnswers_SelectedOptionId_QuestionId",
                table: "QuizAttemptAnswers",
                columns: new[] { "SelectedOptionId", "QuestionId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLessonProgresses_LastUpdatedAt",
                table: "UserLessonProgresses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLessonProgresses_UserId_LastUpdatedAt",
                table: "UserLessonProgresses",
