    ...
    return (
        <section className="bg-white border rounded-xl p-4 grid grid-cols-1 md:grid-cols-5 gap-3 shadow-sm">
            ...
            <div className="md:col-span-5 flex items-center gap-2 justify-end pt-2 border-t mt-2">
                <button onClick={reset} className="px-4 py-2 border rounded-lg hover:bg-gray-50 transition-colors">Reset</button>
                <button onClick={apply} className="px-6 py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition-colors">Apply</button>
            </div>
        </section>
    );
}