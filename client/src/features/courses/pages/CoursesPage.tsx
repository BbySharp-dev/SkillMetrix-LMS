    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-500 mt-1">Tìm khóa học phù hợp với bạn.</p>
            </div>
            ...
            {isError && (
                <div className="p-4 rounded border border-red-200 bg-red-50 text-red-700">
                    Không thể tải khóa học: {String(error)}
                </div>
            )}
            ...
            {isLoading ? (
                ...
                <>
                    <div className="flex items-center justify-between">
                        <p className="text-sm text-gray-500">{data.totalRecords.toLocaleString()} khóa học</p>
                        {isFetching && <span className="text-xs text-indigo-600">Đang cập nhật...</span>}
                    </div>
                ...
                <div className="rounded-xl border bg-white p-12 text-center">
                    ...
                    <p className="text-gray-500 mt-1">Thử thay đổi từ khóa hoặc bộ lọc.</p>
                </div>
            )}
        </div>
    );
